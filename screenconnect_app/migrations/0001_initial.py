...
import screenconnect_app.models
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Asset',
            fields=[
                ('asset_id', models.TextField(default=screenconnect_app.models.generate_asset_id, editable=False, primary_key=True, serialize=False)),
