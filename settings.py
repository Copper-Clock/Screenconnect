...
CONFIG_DIR = '.tccconnect/'
CONFIG_FILE = 'tccconnect.conf'
DEFAULTS = {
    'main': {
        'analytics_opt_out': False,
        'assetdir': 'tccconnect_assets',
        'database': CONFIG_DIR + 'tccconnect.db',
...
class ScreenconnectSettings(UserDict):
    ...
    def load(self):
        """Loads the latest settings from tccconnect.conf into memory."""
...
settings = ScreenconnectSettings()
