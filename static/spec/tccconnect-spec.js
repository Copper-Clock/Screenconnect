...
(function() {
  describe("Screenconnect Open Source", function() {
    it("should have a Screenconnect object at its root", function() {
      return expect(Screenconnect).toBeDefined();
    });
    ...
    describe("Models", function() {
      return describe("Asset model", function() {
        ...
        it("should exist", function() {
          return expect(Screenconnect.Asset).toBeDefined();
        });
    ...
    describe("Collections", function() {
      return describe("Assets", function() {
        it("should exist", function() {
          return expect(Screenconnect.Assets).toBeDefined();
        });
        it("should use the Asset model", function() {
          var assets;
          assets = new Screenconnect.Assets();
          return expect(assets.model).toBe(Screenconnect.Asset);
        });
    ...
    return describe("Views", function() {
      it("should have AddAssetView", function() {
        return expect(Screenconnect.View.AddAssetView).toBeDefined();
      });
      it("should have EditAssetView", function() {
        return expect(Screenconnect.View.EditAssetView).toBeDefined();
      });
      it("should have AssetRowView", function() {
        return expect(Screenconnect.View.AssetRowView).toBeDefined();
      });
      return it("should have AssetsView", function() {
        return expect(Screenconnect.View.AssetsView).toBeDefined();
      });
    });
  });
