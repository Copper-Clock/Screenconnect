...
Screenconnect in your device. However, if you want more control and transparency over
the Balena deployment, follow through the steps below to deploy Screenconnect on your
Balena fleet.
...
Open your terminal and clone the Screenconnect repository if you haven't already:

```bash
$ cd $WORKSPACE_DIRECTORY
$ git clone git@github.com:Copper-Clock/Screenconnect.git
$ cd Screenconnect/
```
...
Once done, the display should show the Screenconnect splash screen. You can now
